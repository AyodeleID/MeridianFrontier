...
const ECONOMIES = [
  {c:'WLD',n:'World'},{c:'NGA',n:'Nigeria'},{c:'GHA',n:'Ghana'},{c:'CIV',n:"C\u00f4te d'Ivoire"},
  {c:'KEN',n:'Kenya'},{c:'ETH',n:'Ethiopia'},{c:'RWA',n:'Rwanda'},{c:'TZA',n:'Tanzania'},
  {c:'UGA',n:'Uganda'},{c:'SEN',n:'Senegal'},{c:'ZAF',n:'South Africa'},{c:'EGY',n:'Egypt'},
  {c:'MAR',n:'Morocco'},{c:'BRA',n:'Brazil'},{c:'IDN',n:'Indonesia'},{c:'IND',n:'India'},
  {c:'VNM',n:'Vietnam'},{c:'BGD',n:'Bangladesh'},{c:'PAK',n:'Pakistan'},{c:'MEX',n:'Mexico'},
  {c:'ARG',n:'Argentina'},{c:'COL',n:'Colombia'},{c:'CHL',n:'Chile'},{c:'CHN',n:'China'},
  {c:'DEU',n:'Germany'},{c:'GBR',n:'United Kingdom'},{c:'FRA',n:'France'},{c:'NLD',n:'Netherlands'},
  {c:'IRL',n:'Ireland'},{c:'USA',n:'United States'},{c:'JPN',n:'Japan'},{c:'KOR',n:'South Korea'},
  {c:'THA',n:'Thailand'},{c:'PHL',n:'Philippines'},{c:'TUR',n:'T\u00fcrkiye'},{c:'POL',n:'Poland'},
  {c:'SSF',n:'Sub-Saharan Africa'},{c:'EUU',n:'European Union'},{c:'LCN',n:'Latin America & Carib.'},
  {c:'SAS',n:'South Asia'},{c:'EAS',n:'East Asia & Pacific'},{c:'LIC',n:'Low income'},
  {c:'LMC',n:'Lower-middle income'},{c:'UMC',n:'Upper-middle income'},{c:'HIC',n:'High income'}
];
